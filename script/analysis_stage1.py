...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (df
               # .Define("dummy_collection", "Mgdemo::dummy_collection(TpcSegStripHits)")
               .Define("strip_x", "Mgdemo::dummy_collection(TpcSegStripHits)")
               .Define("pixel_x", "Mgdemo::dummy_collection(TpcSegPixelHits)")
              )
        return df2
